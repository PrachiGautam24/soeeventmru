-- ============================================================================
-- ORGANIZING COMMITTEE DATA - ICASS 2026
-- ============================================================================
-- This file contains all conference committee members organized by committees
-- These are stored in the ORGANISERS table using the 'role' field
-- ============================================================================

-- Delete existing organisers data to avoid duplicates
...
-- Count total organisers
SELECT COUNT(*) as total_organisers FROM public.organisers;

-- View all organisers by committee (role)
SELECT 
    role,
    name,
    organization,
...
-- List all committees
SELECT DISTINCT role as committee
FROM public.organisers
ORDER BY role;
