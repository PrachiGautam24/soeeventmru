...
(887, '3', 'Compiler Performance Analysis for AI Workloads on RISC-V: A Comprehensive Comparison of GCC and LLVM', 'YUVRAJ.DESHMUKH23@ST.NIITUNIVERSITY.IN', 'Manav Rachna International Institute of Research and Studies, Faridabad', 'offline', 'samarthdhiman2005@gmail.com', 89),
...
(1432, '1', 'SkillMitra: A Hybrid AI Framework for Intelligent Skill Swapping Using SBERT Embeddings, Collaborative Filtering, and NLP-Driven Micro-Challenge Generation', 'SUNANDA', 'Shri Mata Vaishno Devi University, Katra, Jammu', 'online', 'sunanda.gupta@smvdu.ac.in', 155),
(1432, '1', 'SkillMitra: A Hybrid AI Framework for Intelligent Skill Swapping Using SBERT Embeddings, Collaborative Filtering, and NLP-Driven Micro-Challenge Generation', 'DR. SAKSHI ARORA', 'Shri Mata Vaishno Devi University, Katra, Jammu', 'online', 'sakshi@smvdu.ac.in', 156),
