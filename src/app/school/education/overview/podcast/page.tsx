      ...
      <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col">
        <div className="relative bg-secondary">
          ...
          <div className="px-6 pt-10 pb-8 text-center">
            <h1 className="font-bold text-white text-xl">Podcasts & Videos</h1>
            <p className="text-white/70 text-xs mt-1">School of Education · MRU</p>
          </div>
          <div className="h-8">
        ...
        <div className="flex-1 bg-neutral-50 flex items-center justify-center">
          <div className="text-center py-16 px-8">
            <Headphones className="w-12 h-12 text-neutral-200 mx-auto mb-3" />
            <p className="text-sm text-neutral-400">Podcasts & videos coming soon.</p>
          </div>
        </div>
      </div>
    </div>
