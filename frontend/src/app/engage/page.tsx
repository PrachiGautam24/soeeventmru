  ...
  return (
    <>
          ...
          {quickActions.map((a, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl bg-gradient-to-br ${a.color} flex items-center justify-center shadow-sm`}
                  >
      ...
      <section className="mx-4 mt-5">
        ...
        {loading && (
          <div className="h-24 rounded-2xl bg-white border border-neutral-100 animate-pulse" />
        )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-sm">
                Daily Trivia is live
              </p>

              <p className="text-[11px] opacity-80">
                Play now to earn up to 100 XP.
              </p>
            </div>
