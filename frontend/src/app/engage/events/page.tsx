  ...
  async function checkin({
    ...
    if (d.alreadyCheckedIn) {
      ...
      showReward({
        ...
        reason: `Checked in: ${d.event.title}`,
      })
    }
      ...
      <section className="mx-4 mt-2 flex flex-col gap-3 pb-4">
        {loading &&
          Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="h-28 rounded-2xl bg-white border border-neutral-100 animate-pulse"
            />
          ))}
        ...
        {codeOpen && (
          ...
          >
            ...
            >
              ...
              <p className="text-[11px] text-neutral-500">
                Ask the event host for the code.
              </p>
