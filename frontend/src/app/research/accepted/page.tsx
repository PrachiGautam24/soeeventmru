...
import { acceptedPapers } from '@/lib/researchPublications'
      ...
      <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col">
        ...
        <div className="relative bg-secondary">
          ...
          <div className="px-6 pt-10 pb-8 text-center">
            ...
            <h1 className="font-bold text-white text-xl">📬 Accepted Papers</h1>
            <p className="text-white/70 text-xs mt-1">{acceptedPapers.length} papers accepted, awaiting publication</p>
          </div>
          <div className="h-8">
