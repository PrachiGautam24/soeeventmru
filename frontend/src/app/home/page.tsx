  ...
  return (
    <div className="min-h-screen bg-neutral-100 pb-24">
      <div className="max-w-2xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'campus' && (
              <motion.div key="campus"
                ...
                {/* Upcoming Events */}
                <p className="text-xs font-semibold text-neutral-400 uppercase tracking-widest mt-2">Upcoming Events</p>
                <div className="space-y-3">
                  {upcomingEvents.map((ev) => (
                    <div key={ev.title} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-neutral-100 flex">
        ...
        {/* ── Always-visible: Top Recruiters banner + MRU stats ── */}
