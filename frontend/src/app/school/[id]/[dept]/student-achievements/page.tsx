      ...
      <div className="max-w-md mx-auto min-h-screen bg-white shadow-xl flex flex-col">
        ...
        <div className="relative bg-secondary overflow-hidden">
          ...
          <div className="px-6 pt-10 pb-8 text-center">
            ...
            <p className="text-white/70 text-xs mt-1">{department?.name ?? 'Department'}</p>
          </div>
          <div className="h-8">
            ...
            {categories.map(cat => (
              <button
                ...
                className={`shrink-0 px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${
                  active === cat ? categoryColors[cat] : 'bg-neutral-100 text-neutral-500'
                }`}
              >
                {cat}
              </button>
