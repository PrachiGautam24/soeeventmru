...
The school is NBA accredited (valid till 2026) and NAAC accredited, and has collaborations with leading industry and academic partners such as Google Cloud, Xebia, CISCO, KPMG, L&T Edutech, and Truechip, enriching learning experiences and providing students with real-world exposure.`,
    academicPartners: [
      ...
      { name: 'Google',         image: '/images/cse/recruiters/google.png' },
      { name: 'AWS',            image: '/images/cse/recruiters/aws.png' },
      { name: 'Infosys',        image: '/images/cse/recruiters/infosys.png' },
      { name: 'KPMG',           image: '/images/cse/recruiters/kpmg.png' },
      { name: 'HCL GUVI',       image: '/images/cse/recruiters/hclguvi.png' },
      { name: 'Quick Heal',     image: '/images/cse/recruiters/quickheal.png' },
      { name: 'Xebia',          image: '/images/cse/recruiters/xebia.png' },
      { name: 'Coding Ninjas',  image: '/images/cse/recruiters/codingninjas.png' },
      { name: 'CDAC',           image: '/images/cse/recruiters/cdac.png' },
      { name: 'NPTEL',          image: '/images/cse/recruiters/nptel.png' },
      { name: 'Sofocle',        image: '/images/cse/recruiters/sofocle.png' },
      { name: 'Virtual Labs',   image: '/images/cse/recruiters/virtuallabs.png' },
      { name: 'AIW',            image: '/images/cse/recruiters/aiw.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 2.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 3.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 4.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 5.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 6.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 7.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 8.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 9.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 10.png' },
      { name: 'Recruiter',      image: '/images/ece/recruiters/image copy 11.png' },
      { name: 'Altair',         image: '/images/me/recruiters/altair.png' },
      { name: 'Daikin',         image: '/images/me/recruiters/daikin.png' },
      { name: 'L&T',            image: '/images/me/recruiters/lnt.png' },
    ],
    departments: [
      {
